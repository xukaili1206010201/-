...
guanjiaModuleRoute.config(function ($stateProvider) {
  ...
  //})
      ...
      .state('guanjia-support', {
        url: '/guanjia/support.htm?from&label&target',
      ...
      .state('guanjia-goodslist', {
        url: '/guanjia/goodslist.htm?business_id&target',
        templateUrl: 'modules/guanjia/views/goodslist.html',
        controller: 'goodslistCtrl'
      })
      /*
       *@params:from 判断页面从哪儿跳转来service-goodsDetail
       * from = 1; 从购物车下单成功后跳转
      ...
      .state('login-redirect', {
        url: '/guanjia/loginRedirect.htm',
        templateUrl: 'modules/guanjia/views/loginRedirect.html',
      ...
      .state('guanjia-familyservice', {
        url: '/guanjia/familyservice.htm?from&label&target',
      ...
      .state('guanjia-familyservicelist', {
        url: '/guanjia/familyservicelist.htm?target',
      ...
      .state('guanjia-familyservicedetail', {
        url: '/guanjia/familyservicedetail.htm?goodsId&target',
      ...
      .state('guanjia-publicservice', {
        url: '/guanjia/publicservice.htm?label',
        templateUrl: 'modules/guanjia/views/publicservice.html',
        controller: 'publicserviceCtrl'
      })
      .state('guanjia-microservice', {
        url: '/guanjia/microservice.htm',
        templateUrl: 'modules/templates/microService.html',
        controller: 'microServiceCtrl'
      })
